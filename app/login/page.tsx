          ...
          <div className="bg-foreground/5 backdrop-blur-sm p-8 rounded-2xl shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-4 py-3 rounded-lg bg-foreground/10 border border-foreground/20 focus:border-green-500 focus:ring-2 focus:ring-green-500 outline-none transition-all"
